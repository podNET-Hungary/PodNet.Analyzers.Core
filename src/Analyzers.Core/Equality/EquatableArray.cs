...
/// <summary>
/// A simple struct that holds an <see cref="ImmutableArray{T}"/> instance and implements value equality over its items using sequence equality. Can be implicitly converted to and from an <see cref="ImmutableArray{T}"/>.
/// </summary>
